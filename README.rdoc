...
* The questions and number of questions can fluctuate by school: removing a question will destroy all the responses of each of the responding students, and each school can ask different questions.

* Most admins can only work with their own school (i.e. think of an everyday university administrator).  There is a third role that can look across schools
...
* Restrictions requiring students have a proper email end tag to sign up (currently @example.com, @chicagbooth.edu, and @u.northwestern.edu)

* Different schools have different CSS themes

* A basic CSV file can be downloaded on the run factors tab
